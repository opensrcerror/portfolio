...
import { generateRandomRedSquares } from '@/script/shapeBg';

export default function Intro() {
  const { ref } = useSectionInView('Home', 0.6)

  useEffect(() => {
    const cleanup = generateRandomRedSquares(); 
  ...
  return (
    ...
    >
      ...
      >
        hello!! <span className="font-bold">i&apos;m CranzXne!! </span> an epic roblox developer
        with over than <span className="font-bold">4 years </span> of
        experience!
      </motion.h1>
      ...
      >
        ...
        <a
        href="https://github.com/opensrcerror"
        target="_blank"
